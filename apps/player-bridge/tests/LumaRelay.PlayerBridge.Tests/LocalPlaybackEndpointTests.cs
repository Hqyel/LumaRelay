...
{
  private const string AllowedOrigin = "https://lumarelay.example.com";
  ...
  public async Task RedeemsLaunchesAndProxiesRangedMedia()
  {
    ...
    start.Headers.Add("X-LumaRelay-Nonce", "N".PadRight(43, 'N'));
  ...
  public async Task RejectsPlaybackStartFromAnUnpairedBrowser()
  {
    ...
    start.Headers.Add("Origin", AllowedOrigin);
    start.Headers.Add("X-LumaRelay-Nonce", "U".PadRight(43, 'U'));
  ...
  public async Task ReturnsStableErrorWhenGatewayStreamCannotBeOpened()
  {
    ...
    start.Headers.Add("Origin", AllowedOrigin);
    start.Headers.Add("X-LumaRelay-Nonce", "E".PadRight(43, 'E'));
    using var startResponse = await localClient.SendAsync(start);
