...
namespace LumaRelay.PlayerBridge;
  ...
  private static int Main(string[] args)
  {
          ...
          new WindowsProtocolRegistry()))
    {
      Console.Error.WriteLine(
        "The lumarelay:// protocol could not be refreshed. "
  ...
  private static int RunProtocolRegistration(BridgeStartupAction action)
  {
    ...
    try
    {
      ...
      if (action is BridgeStartupAction.RegisterProtocol)
      {
        ...
        Console.WriteLine("lumarelay:// protocol registered for the current user.");
      }
      else
      {
        ProtocolRegistration.Unregister(registry);
        Console.WriteLine("lumarelay:// protocol unregistered for the current user.");
      }
