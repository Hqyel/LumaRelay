  ...
  return (
    ...
    >
      {hasSource && !loaded && !failed ? (
        <span
          aria-hidden="true"
          className="absolute inset-0 overflow-hidden bg-field before:absolute before:inset-0 before:-translate-x-full before:animate-[newemby-shimmer_1.6s_infinite] before:bg-[linear-gradient(90deg,transparent,rgb(var(--theme-foreground-rgb)_/_7%),transparent)] motion-reduce:before:animate-none"
        />
      ) : null}
      {!hasSource || failed ? (
        <span
