...
describe("playback options", () => {
  it("maps direct-stream sources and default tracks without exposing paths", async () => {
          ...
          MediaSources: [
            {
              ...
              MediaStreams: [
                ...
                },
                {
                  ...
                  ExtendedVideoSubTypeDescription: "Dolby Vision Profile 8.1",
                  Height: 1080,
                  Index: 0,
                  IsInterlaced: false,
                  Level: 150,
    ...
    expect(sources).toEqual([
      expect.objectContaining({
        ...
        video: {
          ...
          codecTag: "hvc1",
          displayTitle: "1080p HEVC Main 10",
          dolbyVisionProfile: "Dolby Vision Profile 8.1",
          frameRate: 23.976,
          height: 1080,
          isInterlaced: false,
          level: 150,
    ...
    expect(sources[0]?.audioTracks[0]).toEqual(
      expect.objectContaining({
        bitrate: 256_000,
        channelLayout: "stereo",
        channels: 2,
    ...
    expect(sources[0]?.subtitleTracks[0]).toEqual(
      expect.objectContaining({ isForced: true, language: "chi" }),
    );
